...
| `cash_rounding_unit_syp` | `INT` | `1000` | تقريب المبلغ النقدي لأقرب 1000 ليرة |
...
4. جدول إعدادات المتجر الكامل (ساعات العمل، الصيانة، إيقاف الطلبات، المحافظات المخدَّمة، عتبة الشحن المجاني، سقف الدفع عند الاستلام، حد الطلبات المفتوحة، مهلة التأكيد 48 ساعة، تقريب النقد 1000 ليرة، نوافذ عدم الإزعاج)، وإدارة i18n بمراجعة، ووضع الطوارئ بنطاق ومهلة تلقائية.
