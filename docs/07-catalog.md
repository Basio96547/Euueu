...
| المستوى | التقريب |
|---|---|
| سعر الصنف على البطاقة والصفحة | يُقرَّب لأقرب 1000 **للعرض فقط**، وقيمة غير ملزِمة |
...
تصادف الرقمان هنا، لكنهما يفترقان كثيراً بأصناف أخرى — ولهذا يعرض تفصيل السلة سطراً صريحاً: «المبلغ المستحق يُحسب على المجموع، وقد يختلف عن جمع الأسعار المعروضة بمقدار أقل من 1000 ليرة»، وفرق التقريب يُخزَّن في `orders.rounding_diff_syp` (القسم رقم 8).

**معاينة الأثر قبل الاعتماد** (شاشة `/fx-rates`): قبل تثبيت أي سعر جديد تعرض اللوحة نسبة الانحراف عن السعر الساري، وعدد المنتجات التي سيتغيّر سعرها المعروض بأكثر من 1000 ليرة، وأغلى عشرة منتجات بسعريها القديم والجديد، وعدد الطلبات المحمية بالتثبيت التي **لن** تتأثر. والانحراف الحاد يستوجب تأكيداً ثانياً وملاحظة إلزامية، ويفتح تنبيهاً بمراجعة الكوبونات ذات المبالغ الثابتة وقواعد التسعير النشطة — لأن خصماً بمبلغ ثابت بالدولار يتصرف تصرفاً مختلفاً تماماً بعد قفزة في سعر الصرف.
