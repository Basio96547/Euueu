...
`stock_alerts` يُشغَّل حين ينتقل `inventory_levels.on_hand - reserved` من صفر إلى موجب، و`price_alerts` حين ينخفض `price_usd_cents` بمقدار `threshold_bp` أو أكثر عن السعر وقت الاشتراك. **المقارنة بالدولار حصراً** حتى لا يولّد تغيّر سعر الصرف تنبيهات كاذبة، ونص الرسالة يعرض الليرة مقرَّبة لأقرب 10. حد أقصى إشعار واحد لكل تنبيه كل 24 ساعة، والتنبيه يُغلق تلقائياً بعد الإرسال أو بعد 90 يوماً من الخمول.
