...
export const STAGES: readonly Stage[] = [
  ...
  /* الشاب: مرحلةٌ تختلف عمّا قبلها في **الطبع** لا في الطول وحده.
   *
   * قبلها كان التدرّج صدقاً: وليدٌ ينطق جملةً تامة كذبٌ ينكشف. وبعدها يصير
   * التدرّج نفسه عيباً: شابٌّ يقول «صح؟» بعد كل جملة، ويثغثغ، ويسأل عن كل لفظ،
   * ويُلحق شعوره بكلامه — طفلٌ يتنكّر في هيئة شاب. فتُرفع عنه أحكام الطفولة:
   * لا ثغثغة، ولا تشتّت، ولا جزمٌ بما لا يعرف. */
  { id: 5, name: 'شاب',    minVocab: 650, maxWords: 28, questionBias: 0.12 },
];

/**
 * من هذه المرحلة فصاعداً تُرفع أحكام الطفولة.
 *
 * معلنة رقماً واحداً كي تُقرأ من كل فص: الجبهي يمنع بها الثغثغة، وبروكا تترك
 * بها قوالب الأطفال، والعُقد القاعدية تضيّق بها استكشافها. ولو نُثرت في الفصوص
 * أرقاماً متفرّقة لافترقت كما افترقت قوائم الحروف من قبل.
 */
export const MATURE_STAGE: StageId = 4;
