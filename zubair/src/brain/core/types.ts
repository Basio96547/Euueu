...
export const DIMS = {
   ...
   *
   * والرقم مقيسٌ لا مُقدَّر. كانت ١٦٣٨٤ وهي **وعدٌ لا يفي به جوال**: الذكرى
   * الواحدة ٥٣٠ بايتاً على الجهاز، فالسعة كلُّها ٨٫٣ ميغابايت، والتطبيق يحفظ
   * الدماغ كاملاً **بعد كل درس** — لأن جوالاً يُقفل فجأةً لا ينتظر إذناً.
   * فيصير كلُّ درسٍ يكتب ملفاً بحجم صورة.
   *
   * والقياس: ألفا درسٍ تُنتج دماغاً ٢٫١٣ ميغابايت تُكتب في ٨١ ميلي ثانية.
   * وبهذه السعة يبلغ نحو ستّة ميغابايت وربع الثانية — وذاك بعد ثمانية آلاف
   * درسٍ من حوارٍ حقيقي، أي سنين.
   *
   * ولا يعني بلوغُها فقدانَ ما علّمه: ما حكم عليه الأب وما رسخ بالتثبيت
   * **لا يُنسى** — انظر الطبقة المحميّة في الحُصين.
   */
  episodes: 8192,
...
export interface GrowthMetrics {
  ...
  /** كم ذكرى يحمل */
  episodes: number;
  /** ومنها ما لا يُنسى: ما حكمتَ عليه، وما رسخ بالتثبيت */
  episodesProtected: number;
  /** كم مرة سألك هو */
