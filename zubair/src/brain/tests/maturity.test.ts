...
test('ذاكرته العاملة وذاكرته العرضية اتّسعتا', () => {
  ...
  /* وسعةُ الذكريات هبطت من ١٦٣٨٤ إلى ٨١٩٢ **عن قياس**: الذكرى ٥٣٠ بايتاً على
   * الجهاز، والتطبيق يحفظ الدماغ كاملاً بعد كل درس. فالسعة الأولى كانت وعداً
   * لا يفي به جوال. وما ضاع في السعة رُدّ في الحماية: ما حكمتَ عليه وما رسخ
   * بالتثبيت لا يُنسى مهما امتلأ الحُصين. */
  assert.ok(DIMS.episodes >= 8192, `ولا ينسى أوائل ما عُلّم (${DIMS.episodes} ذكرى)`);
});
