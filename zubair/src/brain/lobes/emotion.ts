...
const SHAMI_COLOR: Record<string, string> = {
  ...
  /* والفخر لا يدّعي اكتشافاً: «شفت؟ عرفت» و«عرفتُها وحدي» كانتا تُلحَقان بجوابٍ
   * أوّلُه «أنت علّمتني»، فتخرج الجملة تناقض نفسها:
   *   «القطة صغيرة، أنت علّمتني، شفت؟ عرفت»
   * وهذا عطبٌ لا يمسّ الدماغ ولا يراه اختبارُ وحدة — رآه أوّلُ تشغيلٍ على
   * شاشة جوال. وفخرُه الصادق أنه **تذكّر** ما عُلّم، لا أنه استنبطه. */
  'فخر': 'مبسوط إني تذكّرت', 'ذنب': 'آسف', 'غيرة': 'وأنا كمان بدي', 'حنين': 'اشتقتلك',
};
...
const FUSHA_COLOR: Record<string, string> = {
  ...
  'فخر': 'سعيدٌ أنّي تذكّرت', 'ذنب': 'آسف', 'غيرة': 'وأنا أيضاً أريد', 'حنين': 'اشتقت إليك',
};
